...
@implementation JTMaintenancePlanView
...
- (FormCell *)form:(FormScrollView *)formScrollView cellForColumnAtIndexPath:(FIndexPath *)indexPath {
    ...
    if ([[[self.dataArray objectAtIndex:indexPath.section+1] objectAtIndex:indexPath.column+1] boolValue]) {
        [cell setImage:[UIImage imageNamed:@"icon_point"] forState:UIControlStateNormal];
    }
    else
    {
