//
//  JTCollectionDetailVideoTableViewCell.m
//  JTCarCustomers
//
...
@implementation JTCollectionDetailVideoTableViewCell
...
- (void)setModel:(JTCollectionModel *)model
{
    ...
    NSString *coverUrlString = [NSString stringWithFormat:@"%@?imageView&thumbnail=%fz%f", model.contentDic[@"coverUrl"], size.width, size.height];
    ...
    [self.contentImage sd_setImageWithURL:[NSURL URLWithString:coverUrlString]];
}
