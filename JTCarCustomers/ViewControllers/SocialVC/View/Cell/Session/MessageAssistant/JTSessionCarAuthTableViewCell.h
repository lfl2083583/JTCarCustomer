//
//  JTSessionCarAuthTableViewCell.h
//  JTCarCustomers
//
...
static NSString *sessionCarAuthIdentifier = @"JTSessionCarAuthTableViewCell";

@interface JTSessionCarAuthTableViewCell : JTSessionTableViewCell
