...
@class JTGrowingTextView;

@protocol JTGrowingTextViewDelegate <NSObject>
@optional
...
- (void)textViewDidBeginEditing:(JTGrowingTextView *)growingTextView;

- (void)textViewDidChangeSelection:(JTGrowingTextView *)growingTextView;

- (void)textViewDidEndEditing:(JTGrowingTextView *)growingTextView;

- (BOOL)textViewShouldBeginEditing:(JTGrowingTextView *)growingTextView;

- (BOOL)textViewShouldEndEditing:(JTGrowingTextView *)growingTextView;
...
@interface JTGrowingTextView : UIScrollView

@property (nonatomic, weak) id<JTGrowingTextViewDelegate> textViewDelegate;
...
@interface JTGrowingTextView (TextView)
