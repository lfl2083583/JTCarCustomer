...
#import "JTGrowingInternalTextView.h"

@interface JTGrowingTextView() <UITextViewDelegate>

@property (nonatomic, strong) JTGrowingInternalTextView *textView;
...
@implementation JTGrowingTextView
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        JTGrowingInternalTextView *textView = [[JTGrowingInternalTextView alloc] initWithFrame:rect];
...
- (instancetype)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        JTGrowingInternalTextView *textView = [[JTGrowingInternalTextView alloc] initWithFrame:CGRectZero];
        self.textView = textView;
...
@implementation JTGrowingTextView (TextView)
