//
//  JTMessageAssistantViewController.m
//  JTCarCustomers
//
...
#import "JTSessionIdentityAuthTableViewCell.h"
...
@interface JTMessageAssistantViewController () <UITableViewDelegate, UITableViewDataSource, JTSessionTableViewCellDelegate>
...
@implementation JTMessageAssistantViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([model isKindOfClass:[JTSessionMessageModel class]]) {
        ...
        if (messageType == NIMMessageTypeCustom) {
            ...
            if ([object.attachment isKindOfClass:[JTActivityPromptAttachment class]]) {
                cell = [tableView dequeueReusableCellWithIdentifier:sessionActivityPromptIdentifier];
            }
            else if ([object.attachment isKindOfClass:[JTBusinessReplyAttachment class]]) {
                cell = [tableView dequeueReusableCellWithIdentifier:sessionBusinessReplyIdentifier];
            }
            else if ([object.attachment isKindOfClass:[JTIdentityAuthAttachment class]]) {
                cell = [tableView dequeueReusableCellWithIdentifier:sessionIdentityAuthIdentifier];
            }
            else if ([object.attachment isKindOfClass:[JTCarAuthAttachment class]]) {
                cell = [tableView dequeueReusableCellWithIdentifier:sessionCarAuthIdentifier];
            }
        }
    }
    else
...
- (void)viewDidLoad {
    ...
    [self.tableview registerClass:[JTSessionActivityPromptTableViewCell class] forCellReuseIdentifier:sessionActivityPromptIdentifier];
    [self.tableview registerClass:[JTSessionBusinessReplyTableViewCell class] forCellReuseIdentifier:sessionBusinessReplyIdentifier];
    [self.tableview registerClass:[JTSessionIdentityAuthTableViewCell class] forCellReuseIdentifier:sessionIdentityAuthIdentifier];
    [self.tableview registerClass:[JTSessionCarAuthTableViewCell class] forCellReuseIdentifier:sessionCarAuthIdentifier];
